...
<table class="table">
  ...
  <tr>
    <td></td>
    <td><label for="calculator"><b>Calculation:</b></label>
      <select name="calculator" id="calculator" onchange="sele()" >
  ...
  <tr>
    <td></td>
    <td><button onclick="clickme()" class="btn btn-danger">Calculate</button></td>
  </tr>
  <tr class="backcolor">
    <td>Result:</td>
    <td><p id="res"></p></td>
